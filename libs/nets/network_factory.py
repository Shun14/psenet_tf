# -*- coding: utf-8 -*-
# @Time    : 2018/8/16 21:50
# @Author  : zsz
# @Site    : 
# @File    : network_factory.py
# @Software: PyCharm
# @Desc     :
...
from libs.nets.slim_nets import mobilenet_v1
from libs.nets.slim_nets import inception_resnet_v2
from libs.nets.slim_nets import vgg
